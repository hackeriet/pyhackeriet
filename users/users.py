...
class Users:
    def __init__(self, file="door.db"):
        ...
        card_data TEXT, enabled INTEGER NOT NULL DEFAULT 1,
        phone TEXT, email TEXT, address TEXT)''')

    def add_user(self, name, phone="", email="", address=""):
        #try:
            with self.db:
                self.db.execute("INSERT INTO users (username, phone, email, address) VALUES (?, ?, ?, ?)", (name, phone, email, address))
